    ...
    <section className="section-padding">
      <div className="container-width">
        ...
        <div className="relative">
          {/* Desktop Timeline */}
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-nf-primary via-nf-accent to-nf-primary transform -translate-y-1/2" />
            ...
            {processSteps.map((step, index) => (
              ...
              >
                ...
                <div className="glass rounded-2xl p-6 relative z-10 hover:shadow-glow-soft transition-all duration-300">
                  {/* Number */}
                  <div className="w-12 h-12 bg-nf-primary rounded-full flex items-center justify-center text-white font-bold font-display mb-4 mx-auto lg:mx-0">
                    {step.number}
                  </div>
