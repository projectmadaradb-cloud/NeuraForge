...
export default function About() {
  return (
    <SectionReveal>
      <div id="about" className="py-20 border-t border-white/10">
        <div className="max-w-4xl mx-auto px-4">
          <div className="glass rounded-2xl p-8 md:p-12">
            <h2 className="heading-lg mb-6">About NeuraForge</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-8">
                <div className="relative">
                  ...
                  <div className="relative z-10 p-6">
                    <h3 className="heading-sm mb-4 text-gradient">Technical Excellence</h3>
                    <ul className="space-y-2 caption">
                      <li className="flex items-start gap-2 group">
                        ...
                        <span className="group-hover:text-purple-300 transition-colors duration-300">Modern frameworks & best practices</span>
                      </li>
                      <li className="flex items-start gap-2 group">
                        <div className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-2 flex-shrink-0 animate-pulse" style={{animationDelay: '0.5s'}}></div>
                        <span className="group-hover:text-purple-300 transition-colors duration-300">Performance-first architecture</span>
                      </li>
                      <li className="flex items-start gap-2 group">
                        <div className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-2 flex-shrink-0 animate-pulse" style={{animationDelay: '1s'}}></div>
                        <span className="group-hover:text-purple-300 transition-colors duration-300">Comprehensive testing & monitoring</span>
                      </li>
                    </ul>
                  </div>
                </div>
