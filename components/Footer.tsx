      ...
      <div className="max-w-8xl mx-auto px-6 py-20 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="flex justify-center items-center text-gray-500 dark:text-white/60 text-lg md:text-xl leading-relaxed max-w-xl font-medium tracking-wide">
            ...
            <div className="mt-8 space-y-4" role="group" aria-labelledby="contact-heading">
              ...
              <p className="flex justify-center items-center text-gray-500 dark:text-white/60 text-lg">
        ...
        <div className="mt-20 pt-12 border-t border-gray-200 dark:border-white/10">
          <div className="text-center">
            ...
            <div className="flex justify-center items-center" role="group" aria-labelledby="footer-social-links">
              <span id="footer-social-links" className="sr-only">Social Media Links</span>
              
              {/* PRECISELY SPACED ICON GRID - Equal distribution from edges */}
              <div className="grid grid-cols-6 gap-3 sm:gap-4 md:gap-6 w-full max-w-xs sm:max-w-sm md:max-w-md">
              
                <a
                  href={SITE.socials.instagram}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex justify-center items-center text-gray-500 dark:text-white/60 hover:text-pink-500 dark:hover:text-pink-400 transition-all duration-500 hover:scale-125 hover:shadow-xl hover:shadow-pink-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-nf-bg rounded-lg p-2 sm:p-3 transform-gpu"
